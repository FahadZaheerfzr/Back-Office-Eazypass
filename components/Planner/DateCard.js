    ...
    >
      ...
      <span>
        {date.declarationStatus === "declared" ? (
          <BiCheckCircle
            className={`text-[#11A628] absolute top-0 bottom-0 my-auto w-4
        ${
          ...
          <MdCancel
            className={`text-[#ff3b3b] absolute top-0 bottom-0 my-auto w-4
        ${
          ...
          <BsFillQuestionCircleFill
            className={`text-[#F9CF00] absolute top-0 bottom-0 my-auto w-4
        ${
          date.timestamp.getDate() == today.getDate() ? "-right-1.5" : "right-0"
        }`}
          />
