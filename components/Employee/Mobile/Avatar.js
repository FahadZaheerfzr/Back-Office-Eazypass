  ...
  return (
    <div className="flex justify-center">
      ...
      >
        ...
        <div className="relative -z-10 inline-block h-1 w-10 xs:h-10 xs:w-10 rounded-full xs:text-base text-sm bg-black text-center pt-1 xs:pt-1.5 font-bold text-white ">
          +{numberOfAttendees - 4}
        </div>
      </div>
