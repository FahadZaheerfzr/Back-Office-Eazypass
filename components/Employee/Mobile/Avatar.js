  ...
  return (
    <div className="flex justify-center">
      ...
      >
        ...
        <div className="relative -z-10 flex h-10 w-10 xs:h-10 xs:w-10 rounded-full xs:text-base text-sm bg-black justify-center items-center font-bold text-white ">
          +{numberOfAttendees - 4}
        </div>
      </div>
